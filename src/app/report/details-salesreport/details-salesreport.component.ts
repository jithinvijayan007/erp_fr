...
import swal from 'sweetalert2';
@Component({
  selector: 'app-details-salesreport',
  templateUrl: './details-salesreport.component.html',
  styleUrls: ['./details-salesreport.component.css']
})
export class DetailsSalesreportComponent implements OnInit {
  ...
  exportData(){
    ...
    this.serviceObject.postData('reports/detailed_sales_report/',dctData).subscribe(
      (response) => {
