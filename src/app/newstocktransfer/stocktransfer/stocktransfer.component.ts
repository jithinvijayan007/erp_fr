...
export class StocktransferComponent implements OnInit {
  ...
  openImei(imeipopup,index) {
    ...
    if(itemStatus){
      ...
      this.serviceObject.postData('stock_transfer/imei_list/ ', {'intItem':this.lstItem[index]['item_id']}).subscribe(
        (response) => {
  ...
  openBatch(batchpopup,index) {
    ...
    if(itemStatus){
      ...
      this.serviceObject.postData('stock_transfer/batch_list/ ', {'intItem':this.lstItemBatch[index]['item_id']}).subscribe(
        (response) => {
  ...
  masterValidation(){
    ...
    if(this.toBranch==null || this.toBranch==''){
      this.toastr.error("Please enter To Branch name");
      return false;
    }
    else if(this.intBranchId==undefined || this.intBranchId==null){
      this.toastr.error("Error","Please enter valid Branch name");
      return false;
    }
    else if(this.transferDate==null){
      this.toastr.error("Error","Please fill Transfer date");
      return false;
    }
    else if(this.strRemarks==null || this.strRemarks==''){
...
courierNameChange(){
  ...
  saveTransfer(){
    ...
    dctData['toBranch']=this.toBranch;
    ...
    this.serviceObject.postData('stock_transfer/save_stock_transfer/ ',dctData).subscribe(
      (response) => {
...
//   "fromBranch":"pottamal",
//   "toBranch":"kattappana",
//   "transferDate":"2020-09-12 12:30:00:00",
...
//       "product_name":"mobile",
//       "lstItemImei":[
//           {'imei':"57899",'imei_age':2,"grn_id":"123"}
//       ],
//       "bln_imei":'True',
//       "int_qty":3,
//       "rate":34,
...
//     "product_name":"mobile",
//     "lstItemTabBatch":[
//         {'batch':"57899",'qty':2,"grn_id":"123","batch_age":77,"transfer_qty":1}
//     ],
//     "bln_imei":'False',
//     "int_qty":3,
//     "rate":34,
...
//   "vechile_no":"kl-06-e-4516",
//   "noofpackages":3,
//   "contack_number":9605889467,
//   rest of the transfer details
