...
@Component({
  selector: 'app-sez-invoice',
  templateUrl: './sez-invoice.component.html',
  styleUrls: ['./sez-invoice.component.css']
})
export class SezInvoiceComponent implements OnInit {
...
// console.log("@@@@@@@@@this.offerDis[this.itemIndex]",this.offerDis[this.itemIndex]);
  ...
  getData(){
    ...
    this.serviceObject.postData('invoice/sales_list/',this.dctData).subscribe(res => {
      ...
      this.intCustType=res['data']['int_cust_type']
...
// -------------------------------------------------
        ...
        if(this.blnCheckExchange){
          ...
          if(!this.blnCheckIGST){
            ...
            // item.dblAmount = Number((item.dblMopAmount + item.dblMarginAmount - (item.dblDiscount)).toFixed(2))
             ...
             console.log(item.dblAmount,item.dblRate,item.dblDiscount,item,'amount1');
    ...
    //  }
      ...
      if(this.blnCheckExchange){
        ...
        if(this.intCouponDisc>0){
          this.intGrandTot= (this.intTotal )- (this.intReturnAmt+this.intCouponDisc+this.intTotIndirectDis)
    
        }
        else{
          this.intGrandTot= (this.intTotal )- (this.intReturnAmt+this.intTotIndirectDis)
  ...
  calculateRate(index,check){
    ...
    // this.lstItemDetails.forEach(element => {
          ...
          if(  this.lstItemDetails[index]['intStatus']==2){
            this.lstItemDetails[index]['dblRate'] = (this.lstItemDetails[index]['dblAmount']) //exchange
          }
...
saveInvoice(){ 
  console.log(this.intApprove,'intApprove',this.blnMakePayment,'blnMakePayment',this.intGrandTot,'intGrandTot');
                ...
                if(this.intGrandTot<0)
                {
                  ...
                  if(this.objectKeys(this.dctData['lstPaymentData']).length>0 || this.intBalanceAmt<=0 || !this.blnMakePayment || this.blnAmazonOrFlipkart)
                  {
                    ...
                    else
                    {
                      ...
                      this.saveDisable=true;
                      console.log(form_data,this.lstItemDetails,"form_data");
      // ====================================================================================
