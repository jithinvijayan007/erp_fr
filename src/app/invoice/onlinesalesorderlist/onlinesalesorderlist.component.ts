...
@Component({
  selector: 'app-onlinesalesorderlist',
  templateUrl: './onlinesalesorderlist.component.html',
  styleUrls: ['./onlinesalesorderlist.component.css']
})
export class OnlinesalesorderlistComponent implements OnInit {
  ...
  {
    localStorage.setItem('onlineSalesId',event.data.intId);
    this.router.navigate(['invoice/onlineinvoice']);
  }
