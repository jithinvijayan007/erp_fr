...
export class GrnpurchaseComponent implements OnInit {
  ...
  savePurchase(){    
      ...
      frmPublishedData.append('intBranch',this.strBranch);
      ...
      dctData['intBranch']=this.strBranch;
  ...
  imeiSearched(){
    ...
    if(this.strImei !=null){
      ...
      if(this.lstItem[this.indexOfImei]['lst_all_imei'] !== null && this.lstItem[this.indexOfImei]['lst_all_imei'].includes(this.strImei)){
        ...
        // if(!this.blnImeiExistValidation){                this code include in response 
    ...
    if(this.blnItemHasImei){
      ...
      if(!this.lstItem[this.indexOfImei].vchr_batch_no){
        ...
        for(let item of this.lstItem){
          ...
          // console.log(item.item_id, this.lstItem[this.indexOfImei].item_id,"yrtyrtry");
...
let checkExist=false
    for (let indexItem = 0; indexItem < this.lstItem.length; indexItem++) {
      if(this.lstItem[indexItem]['item_id']==item.id && this.blnItemHasImei){
    console.log(this.blnItemHasImei,"imei");
  ...
  deleteData(indexId){
    ...
    masterValidation(){
      this.validationStatus=true;  
      // console.log("##this.strSupplier!=this.selectedSupplier");
      // console.log("this.strSupplier",this.strSupplier);
    ...
    detailsValidation(){
      ...
      return;
        ...
        for(let index=0; index<lstLength; index++){
          ...
          rowNum=index+1;
      console.log(this.indexOfImei,index,"index");
          ...
          else if(!this.lstItem[index].vchr_batch_no && !this.lstItem[index].imei_status){
            console.log(this.lstItem[index].vchr_batch_no,);
          ...
          // else if(this.templstImei[index]['imeiStatus']){
          // if(this.lstItem[index].lstImei.length!=ImeiCount){
          // this.validationStatus = false ;
          // this.errorPlace = 'Please fill '+ImeiCount+' IMEI numbers of '+this.lstItem[index].item_name;
          // this.showErrorMessage(this.errorPlace);
          // return;
          // }
          // }
          ...
          //       if(chkLst.includes(this.lstImei[imeiCount].imei)){              
          //       this.validationStatus = false ;
          //       this.errorPlace = 'Duplicated IMEI numbers  of row '+rowNum;
          //       this.showErrorMessage(this.errorPlace);
          //       return;
          //       }
          //       else{
          ...
          // else if(this.lstItem[index].batchNo==null || this.lstItem[index].batchNo==0){
          // this.validationStatus = false ;
          // this.errorPlace = 'Please fill batch number of '+this.lstItem[index].item_name+' on IMEI adding';
          // this.showErrorMessage(this.errorPlace);
          // return;  
          // }

          // else if(this.lstItem[index].lstImei.length!=ImeiCount){
          // this.validationStatus = false ;
          // this.errorPlace = 'Please fill '+ImeiCount+' IMEI numbers of '+this.lstItem[index].item_name;
          // this.showErrorMessage(this.errorPlace);
          // return;
          // }
          // else if(this.lstItem[index].lstImei.length==ImeiCount){
          //   console.log("####this.lstItem[index].lstImei.length==ImeiCount");
            
          // for (let imeiCount = 0; imeiCount < this.lstItem[index].lstImei.length; imeiCount++) {
          //   console.log("####this.lstItem[index].lstImei[imeiCount]",this.lstItem[index].lstImei[imeiCount]);
            
          //   if(this.lstItem[index].lstImei[imeiCount].imei==null){
          //     this.validationStatus = false ;
          //     this.errorPlace = 'Please fill all IMEI numbers of '+this.lstItem[index].item_name;
          //     this.showErrorMessage(this.errorPlace);
          //     return;
          //   }
